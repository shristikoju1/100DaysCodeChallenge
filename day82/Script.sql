...
VALUES 
    ...
    (4, 'Houston', 444, 4, 12),
    (5, 'Miami', 666, 5, 20),
    (6, 'San Francisco', 221, 6, 18),
    (7, 'Seattle', 888, 7, 14),
    (8, 'Dallas', 777, 8, 16),
    (9, 'Atlanta', 333, 9, 11),
    (10, 'Boston', 111, 10, 9),
    (11, 'Philadelphia', 999, 11, 13),
    (12, 'Denver', 666, 12, 17),
    (13, 'Phoenix', 554, 13, 7),
    (14, 'Las Vegas', 221, 14, 22),
    (15, 'Orlando', 332, 15, 19),
    (16, 'Portland', 776, 16, 10),
    (17, 'San Diego', 887, 17, 14),
    (18, 'Minneapolis', 557, 18, 12),
    (19, 'Detroit', 220, 19, 15),
    (20, 'Tampa', 998, 20, 8);

-- Insert data into the Product table
INSERT INTO Product (ProductID, ProductName, Brand, Category, Barcode, SalePrice)
VALUES 
    (1, 'T-Shirt', 'Nike', 'Clothing', '12345', 19.99),
    (2, 'Running Shoes', 'Adidas', 'Footwear', '67890', 79.99),
    (3, 'Smartphone', 'Samsung', 'Electronics', '54321', 499.99),
    (4, 'Headphones', 'Sony', 'Electronics', '45678', 99.99),
    (5, 'Watch', 'Casio', 'Accessories', '98765', 149.99);
